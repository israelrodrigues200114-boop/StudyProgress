...
def page_inicio(all_data):
    ...
    # Desempenho das provas por área: usa as correções dos simulados,
    # preservando os registros antigos de estudo acima.
    st.markdown("### Desempenho nas provas por área")
    if correcoes.empty:
